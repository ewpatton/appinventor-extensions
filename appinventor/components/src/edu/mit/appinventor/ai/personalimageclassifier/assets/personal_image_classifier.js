...
// DEBUGGING only. Remove before production release
...
video.addEventListener('loadeddata' , () => {
  ...
  info.innerHTML = `width: ${width}, height: ${height}<br>vw: ${video.width}, vh: ${video.height}<br>pw: ${previewWidth}, ph: ${previewHeight}`;
}, false);
